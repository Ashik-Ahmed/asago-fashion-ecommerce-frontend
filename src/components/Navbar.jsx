...
const Navbar = () => {
    ...
    return (
        <div className="w-full h-20 bg-sky-400 border-b-[1px] sticky top-0 z-50">
            <nav className="h-full max-w-screen-2xl mx-auto px-4 xl:px-0 flex items-center justify-between gap-2">
                <Link href={"/"}>
